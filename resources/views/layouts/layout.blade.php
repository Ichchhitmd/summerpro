...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="/"><img src="/img/foodhublogoforedit.png" alt="foodhub logo" width="165"
                height="60"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <input class="form-control mr-sm-2" type="text" placeholder="Search" aria-label="Search" style="width:200px" name="search">
